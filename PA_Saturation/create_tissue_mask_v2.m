function [full_map, full_map_hb,full_map_hbo] = create_tissue_mask_v2(epsilon, circle_radius, hbo_C, c_std, fill_pct, full_Nx, full_Ny, Nx, Ny)
...
while loop_flag
    ...
    if good_point
        ...
        hbo_disc = hbo_total* makeDisc(Nx, Ny, x_pos, y_pos, disc_radius);
        hb_disc =  hb_total *makeDisc(Nx, Ny, x_pos, y_pos, disc_radius);
