...
%{
[recon_noise_holder, noisy_sensor_data_holder] = build_pressures_w_noise_v2(E, concentrations, wavelengths, noise_levels, num_x_pixels, num_y_pixels, dx,dy);
recon_data_780_1030 = recon_noise_holder;
[C_nnls, hbo_C, hb_C, sum_C, hbo_S, hb_S, circle_concentration,saturation_error,w_avg] = calc_error_saturation_v2(recon_data_780_1030, E, wavelengths, expected_values, plot_hbo, plot_hb, plot_analysis);
...
[C_nnls, hbo_C, hb_C, sum_C, hbo_S, hb_S, circle_concentration,saturation_error,w_avg] = calc_error_saturation_v2(recon_data_770_780, E, wavelengths, expected_values, plot_hbo, plot_hb, plot_analysis);
...
[C_nnls, hbo_C, hb_C, sum_C, hbo_S, hb_S, circle_concentration,saturation_error,w_avg] = calc_error_saturation_v2(recon_data_all, E, wavelengths, expected_values, plot_hbo, plot_hb, plot_analysis);
...
%error Bar
plot_error_bars(all_circle_data_hbo);
