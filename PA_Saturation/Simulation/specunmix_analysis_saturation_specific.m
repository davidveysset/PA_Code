...
function [full_specunmix_analysis_data,saturation_mean_holder, saturation_std_holder] = specunmix_analysis_saturation_specific(specunmix_data, mask, wavelength_sets, concentrations, noise_simple, type_names, Nx ,Ny, ...
