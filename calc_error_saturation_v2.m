function [C_nnls, hbo_C, hb_C, sum_C, hbo_S, hb_S, circle_concentration, saturation_error,w_avg] = calc_error_saturation_v2(data, E, wavelengths, expected_values, plot_hbo, plot_hb, plot_analysis)
