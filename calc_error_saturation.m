function [C_nnls, hbo_C, hb_C, sum_C, hbo_S, hb_S, circle_concentration, saturation_error] = calc_error_saturation(data, E, wavelengths, expected_values, plot_hbo, plot_hb, plot_analysis)
...
for n = 1:num_noise
    for c = 1:num_concentration
        ...
        %Store the absolute value of the error in saturation error
